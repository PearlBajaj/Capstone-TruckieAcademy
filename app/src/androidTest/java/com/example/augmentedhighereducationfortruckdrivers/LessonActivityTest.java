...
import static com.example.augmentedhighereducationfortruckdrivers.LessonActivity.FILE_REQUEST_CODE;
...
public class LessonActivityTest {
    ...
    public void testFILE_REQUEST_CODE() {
        Intent i = new Intent();
        lActivityTestRule.launchActivity(i);
        assertEquals(FILE_REQUEST_CODE, 1);
    }
    ...
    @Test
    public void testUploadButtonVariable() {
        Intent intent = new Intent(Intent.ACTION_GET_CONTENT);
        lActivityTestRule.launchActivity(intent);
        assertEquals(LessonActivity.upload_button, lActivityTestRule.getActivity().findViewById(R.id.button_upload));
    }
