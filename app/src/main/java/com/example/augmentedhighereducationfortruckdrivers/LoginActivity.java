...
public class LoginActivity extends AppCompatActivity {
    ...
    public static EditText emailTB, passwordTB;
    public static Button login;
    public static SignInButton google_signin;
    public static TextView passwordreset,register;
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(getApplicationContext(), "Login Failed!Incorrect email id or password.", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
