...
public class LessonNodeViewBinder extends BaseNodeViewBinder {
    ...
    public void bindView(TreeNode treeNode) {
        ...
        //set the arrow symbol to invisible if slide has no child( module level), othervise visible
